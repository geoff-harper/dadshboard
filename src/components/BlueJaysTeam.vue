<template>
  <div class="score__team">
    <img :src="`https://raw.githubusercontent.com/geoff-harper/dadshboard/master/docs/mlb/${team.name_abbrev}.png`" :alt="team.team_name" class="score__team-logo">
